...
3. Build. Each map ships as `assets/scenes/<name>.scene.json` beside the executable, and a scene class claims it the way it claims any document — see Capsule's [scene authoring](https://github.com/just-awesome-games/capsule-engine/blob/main/docs/scenes.md).
